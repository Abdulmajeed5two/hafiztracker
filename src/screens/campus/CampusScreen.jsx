...
const CampusScreen = () => {
  const { campusData, fetchCampuses, pageNumber, loading } = useContext(CampusContext);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.campus}>
        <TouchableOpacity style={styles.card}>
            <Image source={icons.Madarsa} style={styles.icon} />
      ...
      <View style={styles.pagination}>
        <TouchableOpacity 
          onPress={() => fetchCampuses(pageNumber - 1)} 
